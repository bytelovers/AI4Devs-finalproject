...
3. Implementa un botón de "Eliminar Mazo" con un modal de confirmación ("¿Estás seguro? Esta acción es irreversible"). Al confirmar, dispara un DELETE hacia `/api/decks/[id]`.